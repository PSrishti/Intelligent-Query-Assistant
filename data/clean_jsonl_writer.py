...
raw_text = """{"text": "Hi, I'm Rajeev and my Samsung Galaxy A52 keeps restarting randomly. It started after a software update. Can you help?", "labels": {"name": "Rajeev", "device type": "Samsung Galaxy A52", "issue description": "keeps restarting randomly", "software": "software update"}}
...
with open("tech_support_ner_train.jsonl", "w") as f:
    for row in cleaned:
